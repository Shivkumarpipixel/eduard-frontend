...
const FestivalCampaign = () => {
    ...
    const installHolidaycampaign = async () => {
        ...
        try {
            ...
            formData.holiday_ai_campaign_product = formData.promote_product == "yes" ? formData.product_name : "no";
            formData.holiday_ai_campaign_purpose = formData.campaign_purpose == "discount"
            ...
            <div className="common_page_container_inner overflow-auto">
                ...
                <div className='lg:w-1/2 w-full'>
                    ...
                    <InputField
                        ...
                        onChange={(ev) =>
                            handleChange("holiday_ai_role", ev.target.value)
                        }
                    />
                    ...
                    <div className='flex gap-5 mb-6 mt-2'>
                        <div className='flex gap-1 items-center'>
                            ...
                            />
                            <label className='text-sm font-medium text-gray-700' htmlFor="wish_only">Only wish</label>
                        </div>
                    ...
                    <label className='text-sm font-medium text-gray-700'>Do you have specific product(s) you would like to promote?</label>
                    <div className='flex gap-5 mb-6 mt-2'>
                        <div className='flex gap-1 items-center'>
                            <input
                                type="radio"
                            ...
                            />
                            <label className='text-sm font-medium text-gray-700' htmlFor="promote_yes">Yes</label>
                        </div>
                        ...
                        <div className='flex gap-1 items-center'>
                            ...
                            />
                            <label className='text-sm font-medium text-gray-700' htmlFor="promote_no">No</label>
                        </div>
                    </div>
                    ...
                    <InputField
                        ...
                        onChange={(ev) =>
                            handleChange("product_name", ev.target.value)
                        }
                    />
                    ...
                    <div className="">
                        <select
                            label={"Which channel would you like to send this campaign through?"}
                            type="text"
                    ...
                    <InputField
                        name="role" // Pass the name prop here
                        label={"Enter the date for the discount or promotion you would like to offer?"}
                        type="date"
                        value={formData.broadcast_date}
                        onChange={(ev) =>
                            handleChange("broadcast_date", ev.target.value)
                        }
                    />
                    ...
                    <div className='mt-6'>
                        ...
                        <textarea className='w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm sm:text-sm mt-2'
                            name="" id=""
