...
const allMenuList = [
  {
    ...
    menuIcon: (
      ...
      <path d="M3 17.5V6.5H4V17.5H3ZM15.712 17.288L14.998 16.6L19.098 12.5H6.385V11.5H19.079L15.023 7.4L15.712 6.712L21 12L15.712 17.288Z" fill="#F1BD6C"/>
      </svg>
...

  {
    ...
    menuIcon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.959 14.724C8.35899 14.724 4.33899 17.652 4.33899 21.25M11.959 11.465C12.8215 11.4671 13.6653 11.2132 14.3835 10.7357C15.1018 10.2581 15.6622 9.57818 15.994 8.782C16.2423 8.18682 16.3553 7.54393 16.3248 6.89976C16.2944 6.25559 16.1212 5.62622 15.8179 5.05711C15.5146 4.488 15.0887 3.99335 14.5709 3.6089C14.0532 3.22444 13.4565 2.95977 12.824 2.834C12.1916 2.7079 11.5391 2.72358 10.9135 2.87991C10.2879 3.03623 9.70476 3.32932 9.20602 3.73806C8.70728 4.14681 8.30537 4.66105 8.02922 5.24376C7.75307 5.82647 7.60955 6.46317 7.60899 7.108C7.60872 8.26242 8.06672 9.36973 8.88236 10.1867C9.698 11.0036 10.8046 11.4634 11.959 11.465Z" stroke="#B688DB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M15.318 15.92C15.4662 15.5967 15.718 15.332 16.0335 15.1678C16.3489 15.0035 16.7101 14.9491 17.06 15.013C17.2997 15.0497 17.5274 15.1421 17.7248 15.2828C17.9223 15.4234 18.084 15.6085 18.197 15.823C18.2781 15.9946 18.3221 16.1814 18.326 16.3711C18.3298 16.5609 18.2936 16.7493 18.2196 16.9241C18.1455 17.0989 18.0354 17.256 17.8964 17.3853C17.7574 17.5145 17.5927 17.6129 17.413 17.674C17.2293 17.7433 17.0704 17.8657 16.9564 18.0256C16.8424 18.1856 16.7786 18.3757 16.773 18.572V18.942" stroke="#B688DB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" />
        <path d="M16.745 20.987H16.747" stroke="#B688DB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
